...
# Scrapy settings for shp project
#
...
SPIDER_MODULES = ['shp.spiders']
NEWSPIDER_MODULE = 'shp.spiders'

# Crawl responsibly by identifying yourself (and your website) on the user-agent
# USER_AGENT = 'shp (+http://www.yourdomain.com)'
...
# SPIDER_MIDDLEWARES = {
#    'shp.middlewares.ShpSpiderMiddleware': 543,
# }

# Enable or disable downloader middlewares
# See https://doc.scrapy.org/en/latest/topics/downloader-middleware.html
# DOWNLOADER_MIDDLEWARES = {
#    'shp.middlewares.ShpDownloaderMiddleware': 543,
# }
